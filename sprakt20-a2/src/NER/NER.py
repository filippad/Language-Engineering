...
class NER(object):
    ...
    def after_The(self):
        return self.last_token == 'the' and self.capitalized_token()

    def after_in(self):
        return self.last_token == 'in' and self.capitalized_token()

    def is_abbrev(self):
        return self.current_token != None and self.current_token.isupper()
    ...
    def __init__(self, training_file, test_file, model_file, stochastic_gradient_descent,
        ...
        self.features = [
            ...
            #NER.FeatureFunction(self.after_The),
            #NER.FeatureFunction(self.is_abbrev),
            NER.FeatureFunction(self.after_in),
        ]
